...
UpgradeVelocityCommentMigrationCheck | .bnd, .gradle or .java | Run code migration of comments from a `velocity` file to a `fremarker` file with the syntax replacements |
