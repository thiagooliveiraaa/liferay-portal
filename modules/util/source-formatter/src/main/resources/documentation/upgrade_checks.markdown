...
UpgradeVelocityCommentMigrationCheck | .bnd, .gradle, .java or .vm | Run code migration of comments from a `velocity` file to a `fremarker` file with the syntax replacements |
