...
package com.liferay.portal.tools.service.builder.spring.sample.service.base;
...
/**
 * Provides the base implementation for the spring entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.tools.service.builder.spring.sample.service.impl.SpringEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.portal.tools.service.builder.spring.sample.service.impl.SpringEntryLocalServiceImpl
 * @generated
 */
public abstract class SpringEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, SpringEntryLocalService {
	...
	public SpringEntry addSpringEntry(SpringEntry springEntry) {
		...
		return springEntryPersistence.update(springEntry);
	}
	...
	public SpringEntry deleteSpringEntry(SpringEntry springEntry) {
		return springEntryPersistence.remove(springEntry);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return springEntryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SpringEntry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return springEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return springEntryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return springEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return springEntryPersistence.countWithDynamicQuery(
	...
	public SpringEntry fetchSpringEntryByUuidAndCompanyId(
		...
		return springEntryPersistence.fetchByUuid_C_First(
			uuid, companyId, null);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(springEntryLocalService);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return springEntryPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SpringEntryLocalServiceImpl#deleteSpringEntry(SpringEntry) to avoid orphaned data");
		}

		return springEntryLocalService.deleteSpringEntry(
			(SpringEntry)persistedModel);
	}

	@Override
	public BasePersistence<SpringEntry> getBasePersistence() {
		return springEntryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return springEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public SpringEntry getSpringEntryByUuidAndCompanyId(
		...
		return springEntryPersistence.findByUuid_C_First(uuid, companyId, null);
	}
	...
	public List<SpringEntry> getSpringEntries(int start, int end) {
		return springEntryPersistence.findAll(start, end);
	}
	...
	public int getSpringEntriesCount() {
		return springEntryPersistence.countAll();
	}
	...
	/**
	 * Returns the spring entry local service.
	 *
	 * @return the spring entry local service
	 */
	public SpringEntryLocalService getSpringEntryLocalService() {
		return springEntryLocalService;
	}

	/**
	 * Sets the spring entry local service.
	 *
	 * @param springEntryLocalService the spring entry local service
	 */
	public void setSpringEntryLocalService(
		SpringEntryLocalService springEntryLocalService) {

		this.springEntryLocalService = springEntryLocalService;
	}

	/**
	 * Returns the spring entry persistence.
	 *
	 * @return the spring entry persistence
	 */
	public SpringEntryPersistence getSpringEntryPersistence() {
		return springEntryPersistence;
	}

	/**
	 * Sets the spring entry persistence.
	 *
	 * @param springEntryPersistence the spring entry persistence
	 */
	public void setSpringEntryPersistence(
		SpringEntryPersistence springEntryPersistence) {

		this.springEntryPersistence = springEntryPersistence;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SpringEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = springEntryPersistence.getDataSource();
	...
	@BeanReference(type = SpringEntryLocalService.class)
	protected SpringEntryLocalService springEntryLocalService;

	@BeanReference(type = SpringEntryPersistence.class)
	protected SpringEntryPersistence springEntryPersistence;
