...
/**
 * Provides the base implementation for the rsv entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.revert.schema.version.service.impl.RSVEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.revert.schema.version.service.impl.RSVEntryLocalServiceImpl
 * @generated
 */
public abstract class RSVEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, RSVEntryLocalService {
	...
	public RSVEntry createRSVEntry(long rsvEntryId) {
		return rsvEntryPersistence.create(rsvEntryId);
	}
	...
	public RSVEntry deleteRSVEntry(long rsvEntryId) throws PortalException {
		return rsvEntryPersistence.remove(rsvEntryId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			RSVEntry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return rsvEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return rsvEntryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return rsvEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return rsvEntryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public RSVEntry fetchRSVEntry(long rsvEntryId) {
		return rsvEntryPersistence.fetchByPrimaryKey(rsvEntryId);
	}
	...
	public RSVEntry getRSVEntry(long rsvEntryId) throws PortalException {
		return rsvEntryPersistence.findByPrimaryKey(rsvEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(rsvEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RSVEntry.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(RSVEntry.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return rsvEntryPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return rsvEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<RSVEntry> getRSVEntries(int start, int end) {
		return rsvEntryPersistence.findAll(start, end);
	}
	...
	public int getRSVEntriesCount() {
		return rsvEntryPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RSVEntryLocalService.class, IdentifiableOSGiService.class,
	...
	public String getOSGiServiceIdentifier() {
		return RSVEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = rsvEntryPersistence.getDataSource();
	...
	@Reference
	protected RSVEntryPersistence rsvEntryPersistence;
