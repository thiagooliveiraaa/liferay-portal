...
public abstract class BaseTimeRangeResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/portal-workflow-metrics/v1.0/time-ranges/export-batch'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.Path("/time-ranges/export-batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response postTimeRangesPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				TimeRange.class.getName(), callbackURL, contentType, fieldNames)
		).build();
	}
