...
public abstract class SourceLocalServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, SourceLocalService {
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sourcePersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return sourcePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SourceLocalServiceImpl#deleteSource(Source) to avoid orphaned data");
		}
	...
	@Override
	public BasePersistence<Source> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SourceLocalService.class, IdentifiableOSGiService.class,
