...
public interface ContactsLayoutTemplatePersistence
	 ...
	 */
	public java.util.List<ContactsLayoutTemplate> findByGroupId(long groupId);
	 ...
	 */
	public java.util.List<ContactsLayoutTemplate> findAll();
	 ...
	 */
	public java.util.List<ContactsLayoutTemplate> findAll(int start, int end);
