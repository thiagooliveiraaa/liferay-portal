...
public abstract class BaseMLModelResourceImpl
	implements EntityModelResource, MLModelResource,
			   VulcanBatchEngineTaskItemDelegate<MLModel> {
	...
	public Page<MLModel> getSentenceTransformerMLModelsPage(
			...
			Integer limit,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("pipelineTag")
			String pipelineTag,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("query")
			String query,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("tag")
			String tag)
		throws Exception {
	...
	public void create(
			Collection<MLModel> mlModels, Map<String, Serializable> parameters)
		throws Exception {
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseMLModelResourceImpl.class);
