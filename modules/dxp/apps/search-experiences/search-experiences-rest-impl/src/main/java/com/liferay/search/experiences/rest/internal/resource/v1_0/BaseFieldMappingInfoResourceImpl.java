...
public abstract class BaseFieldMappingInfoResourceImpl
	implements EntityModelResource, FieldMappingInfoResource,
			   VulcanBatchEngineTaskItemDelegate<FieldMappingInfo> {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/search-experiences-rest/v1.0/field-mapping-infos'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "FieldMappingInfo")
		}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/field-mapping-infos")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/search-experiences-rest/v1.0/field-mapping-infos/export-batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Path("/field-mapping-infos/export-batch")
	@javax.ws.rs.POST
	...
	public Response postFieldMappingInfosPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				FieldMappingInfo.class.getName(), callbackURL, contentType,
				fieldNames)
		).build();
	}
	...
	public void create(
			Collection<FieldMappingInfo> fieldMappingInfos,
