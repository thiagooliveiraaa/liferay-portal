...
public abstract class BaseSXPParameterContributorDefinitionResourceImpl
	implements EntityModelResource, SXPParameterContributorDefinitionResource,
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/search-experiences-rest/v1.0/sxp-parameter-contributor-definitions'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/sxp-parameter-contributor-definitions")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/search-experiences-rest/v1.0/sxp-parameter-contributor-definitions/export-batch'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.Path("/sxp-parameter-contributor-definitions/export-batch")
	@javax.ws.rs.POST
	...
	public Response postSXPParameterContributorDefinitionsPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				SXPParameterContributorDefinition.class.getName(), callbackURL,
	...
	public Page<SXPParameterContributorDefinition> read(
		...
		return getSXPParameterContributorDefinitionsPage();
	}
