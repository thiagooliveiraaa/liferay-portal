...
public abstract class BaseQueryPrefilterContributorResourceImpl
	implements EntityModelResource, QueryPrefilterContributorResource,
			   VulcanBatchEngineTaskItemDelegate<QueryPrefilterContributor> {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/search-experiences-rest/v1.0/query-prefilter-contributors'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/query-prefilter-contributors")
	...
	public void create(
			Collection<QueryPrefilterContributor> queryPrefilterContributors,
	...
	public Page<QueryPrefilterContributor> read(
		...
		return getQueryPrefilterContributorsPage();
	}
