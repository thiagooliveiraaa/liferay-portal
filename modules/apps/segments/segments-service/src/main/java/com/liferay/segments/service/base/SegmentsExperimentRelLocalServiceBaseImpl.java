...
public abstract class SegmentsExperimentRelLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SegmentsExperimentRelLocalServiceImpl#deleteSegmentsExperimentRel(SegmentsExperimentRel) to avoid orphaned data");
		}
	...
	protected void deactivate() {
		SegmentsExperimentRelLocalServiceUtil.setService(null);
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		SegmentsExperimentRelLocalServiceUtil.setService(
			segmentsExperimentRelLocalService);
	}
