...
public abstract class NotificationQueueEntryLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement NotificationQueueEntryLocalServiceImpl#deleteNotificationQueueEntry(NotificationQueueEntry) to avoid orphaned data");
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NotificationQueueEntryLocalServiceBaseImpl.class);
