...
public class JournalArticleLayoutClassedModelUsageUpgradeProcess
	...
	private void _addAssetPublisherPortletPreferencesLayoutClassedModelUsages(
		...
		String sql = StringBundler.concat(
			...
			"(CAST_TEXT(PortletPreferenceValue1.smallValue) = 'manual' or ",
			"CAST_TEXT(PortletPreferenceValue1.largeValue) = 'manual') inner ",
			"join PortletPreferenceValue PortletPreferenceValue2 on ",
			"PortletPreferenceValue2.portletPreferencesId = ",
			"PortletPreferences.portletPreferencesId and ",
			"CAST_TEXT(PortletPreferenceValue2.name) = 'assetEntryXml' and ",
			"(CAST_TEXT(PortletPreferenceValue2.smallValue) like CONCAT('%', ",
			"AssetEntry.classUuid, '%') or ",
			"CAST_TEXT(PortletPreferenceValue2.largeValue) like CONCAT('%', ",
			"AssetEntry.classUuid, '%')) where PortletPreferences.companyId = ",
			"AssetEntry.companyId and PortletPreferences.ownerId = ",
