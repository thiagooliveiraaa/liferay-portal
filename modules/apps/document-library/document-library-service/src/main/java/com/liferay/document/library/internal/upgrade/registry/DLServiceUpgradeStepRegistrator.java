...
import com.liferay.document.library.internal.upgrade.v3_2_7.DLFileEntryResourcePermissionUpgradeProcess;
...
public class DLServiceUpgradeStepRegistrator implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		...
		registry.register(
			"3.2.6", "3.2.7",
			new DLFileEntryResourcePermissionUpgradeProcess(
