...
<#assign
	...
	MARKETPLACE_PRICE_VOCABULARY_ID = 8823920
/>
	...
	<div class="cards-container pb-6">
		<#if entries?has_content>
			<#list entries as curCPCatalogEntry>
				...
				<a class="solutions-search-results-card bg-white border-radius-medium color-black flex flex-column mb-0 p-3 text-decoration-none" href=${friendlyURL}>
