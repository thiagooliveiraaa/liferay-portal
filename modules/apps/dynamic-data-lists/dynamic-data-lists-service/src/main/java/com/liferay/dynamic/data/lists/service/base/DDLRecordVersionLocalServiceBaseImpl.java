...
public abstract class DDLRecordVersionLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DDLRecordVersionLocalServiceImpl#deleteDDLRecordVersion(DDLRecordVersion) to avoid orphaned data");
		}
	...
	protected void deactivate() {
		DDLRecordVersionLocalServiceUtil.setService(null);
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		DDLRecordVersionLocalServiceUtil.setService(
			ddlRecordVersionLocalService);
	}
