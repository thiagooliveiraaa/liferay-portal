...
public abstract class DDLRecordSetLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DDLRecordSetLocalServiceImpl#deleteDDLRecordSet(DDLRecordSet) to avoid orphaned data");
		}
	...
	public <R, E extends Throwable> R updateWithUnsafeFunction(
		...
		return updateUnsafeFunction.apply(ddlRecordSetPersistence);
	}
