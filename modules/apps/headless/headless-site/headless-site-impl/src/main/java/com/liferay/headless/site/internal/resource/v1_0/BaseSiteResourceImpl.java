...
public abstract class BaseSiteResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/headless-site/v1.0/sites/{groupId}'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.Path("/sites/{groupId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@javax.ws.rs.PUT
	@Override
	public Site putSite(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/headless-site/v1.0/sites/{groupId}/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Consumes("application/json")
	@javax.ws.rs.Path("/sites/{groupId}/batch")
	@javax.ws.rs.Produces("application/json")
	@javax.ws.rs.PUT
	@Override
	...
	public void update(
		...
		if ("UPDATE".equalsIgnoreCase(updateStrategy)) {
			siteUnsafeConsumer = site -> putSite(groupId, null);
		}
