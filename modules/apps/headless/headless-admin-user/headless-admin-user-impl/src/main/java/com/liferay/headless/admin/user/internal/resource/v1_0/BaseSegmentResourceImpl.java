...
public abstract class BaseSegmentResourceImpl
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Segment")}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/sites/{siteId}/segments")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-admin-user/v1.0/sites/{siteId}/segments/export-batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Path("/sites/{siteId}/segments/export-batch")
	@javax.ws.rs.POST
	...
	public Response postSiteSegmentsPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				Segment.class.getName(), callbackURL, contentType, fieldNames)
		).build();
	}
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/sites/{siteId}/user-accounts/{userAccountId}/segments")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	public void create(
			Collection<Segment> segments, Map<String, Serializable> parameters)
		throws Exception {
