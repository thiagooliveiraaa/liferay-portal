...
public class RequiredUserGroupExceptionMapper
	extends BaseExceptionMapper<RequiredUserGroupException> {
	...
	protected Problem getProblem(
		...
		return new Problem(
			...
			"All users must be deleted before deleting this user group");
	}
