...
public abstract class BaseTicketResourceImpl implements TicketResource {
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/user-accounts/{userAccountId}/email-verification-ticket"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Ticket getUserAccountEmailVerificationTicket(
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/user-accounts/{userAccountId}/password-reset-ticket")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Ticket getUserAccountPasswordResetTicket(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("userAccountId")
			Long userAccountId)
