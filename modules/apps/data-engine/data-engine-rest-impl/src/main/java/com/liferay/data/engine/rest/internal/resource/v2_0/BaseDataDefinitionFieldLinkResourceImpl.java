...
public abstract class BaseDataDefinitionFieldLinkResourceImpl
	implements DataDefinitionFieldLinkResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<DataDefinitionFieldLink> {
	...
	public Page<DataDefinitionFieldLink>
			getDataDefinitionDataDefinitionFieldLinksPage(
				...
				@io.swagger.v3.oas.annotations.Parameter(hidden = true)
				@javax.ws.rs.QueryParam("fieldName")
				String fieldName)
		throws Exception {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/data-engine/v2.0/data-definitions/{dataDefinitionId}/data-definition-field-links/export-batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Path(
		"/data-definitions/{dataDefinitionId}/data-definition-field-links/export-batch"
	)
	@javax.ws.rs.POST
	...
	public Response postDataDefinitionDataDefinitionFieldLinksPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				DataDefinitionFieldLink.class.getName(), callbackURL,
	...
	public void create(
			Collection<DataDefinitionFieldLink> dataDefinitionFieldLinks,
