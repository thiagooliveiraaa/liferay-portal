...
public abstract class BatchPlannerMappingLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement BatchPlannerMappingLocalServiceImpl#deleteBatchPlannerMapping(BatchPlannerMapping) to avoid orphaned data");
		}
	...
	protected void deactivate() {
		BatchPlannerMappingLocalServiceUtil.setService(null);
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		BatchPlannerMappingLocalServiceUtil.setService(
			batchPlannerMappingLocalService);
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BatchPlannerMappingLocalServiceBaseImpl.class);
