...
public abstract class AssetListEntrySegmentsEntryRelLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AssetListEntrySegmentsEntryRelLocalServiceImpl#deleteAssetListEntrySegmentsEntryRel(AssetListEntrySegmentsEntryRel) to avoid orphaned data");
		}
	...
	protected void deactivate() {
		AssetListEntrySegmentsEntryRelLocalServiceUtil.setService(null);
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		AssetListEntrySegmentsEntryRelLocalServiceUtil.setService(
			assetListEntrySegmentsEntryRelLocalService);
	}
