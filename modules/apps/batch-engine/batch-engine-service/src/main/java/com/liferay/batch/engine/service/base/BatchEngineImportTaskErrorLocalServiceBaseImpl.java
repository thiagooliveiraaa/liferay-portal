...
public abstract class BatchEngineImportTaskErrorLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement BatchEngineImportTaskErrorLocalServiceImpl#deleteBatchEngineImportTaskError(BatchEngineImportTaskError) to avoid orphaned data");
		}
	...
	protected void deactivate() {
		BatchEngineImportTaskErrorLocalServiceUtil.setService(null);
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		BatchEngineImportTaskErrorLocalServiceUtil.setService(
			batchEngineImportTaskErrorLocalService);
	}
