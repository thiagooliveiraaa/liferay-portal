...
/**
 * Provides the local service utility for BatchEngineImportTaskError. This utility wraps
 * <code>com.liferay.batch.engine.service.impl.BatchEngineImportTaskErrorLocalServiceImpl</code> and
 ...
 * @generated
 */
public class BatchEngineImportTaskErrorLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.batch.engine.service.impl.BatchEngineImportTaskErrorLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static BatchEngineImportTaskError createBatchEngineImportTaskError(
		long batchEngineImportTaskErrorId) {

		return getService().createBatchEngineImportTaskError(
	 ...
	 */
	public static BatchEngineImportTaskError deleteBatchEngineImportTaskError(
		BatchEngineImportTaskError batchEngineImportTaskError) {

		return getService().deleteBatchEngineImportTaskError(
			batchEngineImportTaskError);
	}
	...
	public static BatchEngineImportTaskError fetchBatchEngineImportTaskError(
		long batchEngineImportTaskErrorId) {

		return getService().fetchBatchEngineImportTaskError(
			batchEngineImportTaskErrorId);
	}
	 ...
	 * @throws PortalException if a batch engine import task error with the primary key could not be found
	 */
	public static BatchEngineImportTaskError getBatchEngineImportTaskError(
			long batchEngineImportTaskErrorId)
		throws PortalException {

		return getService().getBatchEngineImportTaskError(
			batchEngineImportTaskErrorId);
	}
	 ...
	 */
	public static BatchEngineImportTaskError updateBatchEngineImportTaskError(
		BatchEngineImportTaskError batchEngineImportTaskError) {

		return getService().updateBatchEngineImportTaskError(
			batchEngineImportTaskError);
	}

	public static BatchEngineImportTaskErrorLocalService getService() {
		return _service;
	}
