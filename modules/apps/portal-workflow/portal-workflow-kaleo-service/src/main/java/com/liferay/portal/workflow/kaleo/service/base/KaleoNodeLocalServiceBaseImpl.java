...
public abstract class KaleoNodeLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement KaleoNodeLocalServiceImpl#deleteKaleoNode(KaleoNode) to avoid orphaned data");
		}
	...
	public <R, E extends Throwable> R updateWithUnsafeFunction(
		...
		return updateUnsafeFunction.apply(kaleoNodePersistence);
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		KaleoNodeLocalServiceBaseImpl.class);
