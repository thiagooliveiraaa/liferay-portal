...
public abstract class KaleoTaskLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement KaleoTaskLocalServiceImpl#deleteKaleoTask(KaleoTask) to avoid orphaned data");
		}
	...
	protected void deactivate() {
		KaleoTaskLocalServiceUtil.setService(null);
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		KaleoTaskLocalServiceUtil.setService(kaleoTaskLocalService);
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		KaleoTaskLocalServiceBaseImpl.class);
