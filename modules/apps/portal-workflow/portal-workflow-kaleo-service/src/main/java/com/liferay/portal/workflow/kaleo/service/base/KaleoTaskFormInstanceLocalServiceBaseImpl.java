...
public abstract class KaleoTaskFormInstanceLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement KaleoTaskFormInstanceLocalServiceImpl#deleteKaleoTaskFormInstance(KaleoTaskFormInstance) to avoid orphaned data");
		}
	...
	@Override
	public BasePersistence<KaleoTaskFormInstance> getBasePersistence() {
	...
	public <R, E extends Throwable> R updateWithUnsafeFunction(
		...
		return updateUnsafeFunction.apply(kaleoTaskFormInstancePersistence);
	}
