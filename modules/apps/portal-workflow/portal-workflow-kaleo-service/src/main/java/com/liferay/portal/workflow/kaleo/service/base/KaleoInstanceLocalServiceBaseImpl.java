...
public abstract class KaleoInstanceLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement KaleoInstanceLocalServiceImpl#deleteKaleoInstance(KaleoInstance) to avoid orphaned data");
		}
	...
	protected void deactivate() {
		KaleoInstanceLocalServiceUtil.setService(null);
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		KaleoInstanceLocalServiceUtil.setService(kaleoInstanceLocalService);
	}
	...
	public <R, E extends Throwable> R updateWithUnsafeFunction(
		...
		return updateUnsafeFunction.apply(kaleoInstancePersistence);
	}
