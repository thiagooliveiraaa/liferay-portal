...
public abstract class KaleoLogLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement KaleoLogLocalServiceImpl#deleteKaleoLog(KaleoLog) to avoid orphaned data");
		}
	...
	protected void deactivate() {
		KaleoLogLocalServiceUtil.setService(null);
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		KaleoLogLocalServiceUtil.setService(kaleoLogLocalService);
	}
	...
	public <R, E extends Throwable> R updateWithUnsafeFunction(
		...
		return updateUnsafeFunction.apply(kaleoLogPersistence);
	}
