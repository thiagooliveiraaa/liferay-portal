...
public abstract class KaleoInstanceTokenLocalServiceBaseImpl
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return kaleoInstanceTokenPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return kaleoInstanceTokenPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement KaleoInstanceTokenLocalServiceImpl#deleteKaleoInstanceToken(KaleoInstanceToken) to avoid orphaned data");
		}
	...
	public <R, E extends Throwable> R updateWithUnsafeFunction(
		...
		return updateUnsafeFunction.apply(kaleoInstanceTokenPersistence);
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		KaleoInstanceTokenLocalServiceBaseImpl.class);
