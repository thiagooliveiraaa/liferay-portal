...
public abstract class KaleoTimerLocalServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, KaleoTimerLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>KaleoTimerLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>KaleoTimerLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return kaleoTimerPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			KaleoTimer.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return kaleoTimerPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return kaleoTimerPersistence.countWithDynamicQuery(
	 ...
	 */
	@Override
	public KaleoTimer getKaleoTimer(long kaleoTimerId) throws PortalException {
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return kaleoTimerPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement KaleoTimerLocalServiceImpl#deleteKaleoTimer(KaleoTimer) to avoid orphaned data");
		}

		return kaleoTimerLocalService.deleteKaleoTimer(
			(KaleoTimer)persistedModel);
	}

	@Override
	public BasePersistence<KaleoTimer> getBasePersistence() {
	...
	protected void deactivate() {
		KaleoTimerLocalServiceUtil.setService(null);
	}

	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			KaleoTimerLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		kaleoTimerLocalService = (KaleoTimerLocalService)aopProxy;

		KaleoTimerLocalServiceUtil.setService(kaleoTimerLocalService);
	}
	...
	public <R, E extends Throwable> R updateWithUnsafeFunction(
		...
		return updateUnsafeFunction.apply(kaleoTimerPersistence);
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		KaleoTimerLocalServiceBaseImpl.class);
