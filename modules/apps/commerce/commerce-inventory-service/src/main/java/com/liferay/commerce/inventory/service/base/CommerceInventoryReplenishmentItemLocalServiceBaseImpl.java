...
public abstract class CommerceInventoryReplenishmentItemLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CommerceInventoryReplenishmentItemLocalServiceImpl#deleteCommerceInventoryReplenishmentItem(CommerceInventoryReplenishmentItem) to avoid orphaned data");
		}
