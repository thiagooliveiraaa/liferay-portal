...
public abstract class CommerceInventoryBookedQuantityLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CommerceInventoryBookedQuantityLocalServiceImpl#deleteCommerceInventoryBookedQuantity(CommerceInventoryBookedQuantity) to avoid orphaned data");
		}
