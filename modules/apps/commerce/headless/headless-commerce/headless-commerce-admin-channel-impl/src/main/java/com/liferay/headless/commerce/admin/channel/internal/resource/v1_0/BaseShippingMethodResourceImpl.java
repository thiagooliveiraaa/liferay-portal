...
public abstract class BaseShippingMethodResourceImpl
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/channels/{channelId}/shipping-methods")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-channel/v1.0/channels/{channelId}/shipping-methods/export-batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Path("/channels/{channelId}/shipping-methods/export-batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response postChannelShippingMethodsPageExportBatch(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("channelId")
			Long channelId,
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				ShippingMethod.class.getName(), callbackURL, contentType,
				fieldNames)
		).build();
	}
	...
	public void create(
			Collection<ShippingMethod> shippingMethods,
	...
	public Page<ShippingMethod> read(
		...
		if (parameters.containsKey("channelId")) {
			...
			throw new NotSupportedException(
				"One of the following parameters must be specified: [channelId]");
		}
	}
