...
public abstract class BasePaymentMethodResourceImpl
	implements EntityModelResource, PaymentMethodResource,
			   VulcanBatchEngineTaskItemDelegate<PaymentMethod> {
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "PaymentMethod")
		}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/carts/{cartId}/payment-methods")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<PaymentMethod> getCartPaymentMethodsPage(
	...
	@javax.ws.rs.Path("/carts/{cartId}/payment-methods/export-batch")
	@javax.ws.rs.POST
	...
	public Response postCartPaymentMethodsPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				PaymentMethod.class.getName(), callbackURL, contentType,
				fieldNames)
		).build();
	}
