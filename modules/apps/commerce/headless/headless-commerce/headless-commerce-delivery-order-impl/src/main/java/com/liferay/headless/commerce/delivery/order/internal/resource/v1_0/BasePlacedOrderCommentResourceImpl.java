...
public abstract class BasePlacedOrderCommentResourceImpl
	implements EntityModelResource, PlacedOrderCommentResource,
			   VulcanBatchEngineTaskItemDelegate<PlacedOrderComment> {
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "PlacedOrderComment")
		}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/placed-order-comments/{placedOrderCommentId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public PlacedOrderComment getPlacedOrderComment(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("placedOrderCommentId")
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/placed-orders/{placedOrderId}/placed-order-comments")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-delivery-order/v1.0/placed-orders/{placedOrderId}/placed-order-comments/export-batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Path(
		"/placed-orders/{placedOrderId}/placed-order-comments/export-batch"
	)
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response postPlacedOrderPlacedOrderCommentsPageExportBatch(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("placedOrderId")
			Long placedOrderId,
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				PlacedOrderComment.class.getName(), callbackURL, contentType,
				fieldNames)
		).build();
	}
	...
	public void create(
			Collection<PlacedOrderComment> placedOrderComments,
