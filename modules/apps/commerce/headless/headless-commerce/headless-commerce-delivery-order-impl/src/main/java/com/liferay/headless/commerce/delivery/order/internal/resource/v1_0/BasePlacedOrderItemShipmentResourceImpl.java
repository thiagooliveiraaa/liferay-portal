...
public abstract class BasePlacedOrderItemShipmentResourceImpl
	implements EntityModelResource, PlacedOrderItemShipmentResource,
			   VulcanBatchEngineTaskItemDelegate<PlacedOrderItemShipment> {
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/placed-order-items/{placedOrderItemId}/placed-order-item-shipments"
	)
	...
	public Page<PlacedOrderItemShipment>
			getPlacedOrderItemPlacedOrderItemShipmentsPage(
				...
				@javax.ws.rs.PathParam("placedOrderItemId")
	...
	@javax.ws.rs.Path(
		"/placed-order-items/{placedOrderItemId}/placed-order-item-shipments/export-batch"
	)
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response postPlacedOrderItemPlacedOrderItemShipmentsPageExportBatch(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("placedOrderItemId")
			Long placedOrderItemId,
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				PlacedOrderItemShipment.class.getName(), callbackURL,
	...
	public void create(
			Collection<PlacedOrderItemShipment> placedOrderItemShipments,
	...
	public Page<PlacedOrderItemShipment> read(
		...
		if (parameters.containsKey("placedOrderItemId")) {
			...
			throw new NotSupportedException(
				"One of the following parameters must be specified: [placedOrderItemId]");
		}
	}
