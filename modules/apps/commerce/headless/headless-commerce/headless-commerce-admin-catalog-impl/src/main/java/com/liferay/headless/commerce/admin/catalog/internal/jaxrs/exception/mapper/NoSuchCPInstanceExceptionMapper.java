...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.NoSuchCPInstanceExceptionMapper"
	},
...
public class NoSuchCPInstanceExceptionMapper
	...
	protected Problem getProblem(
		NoSuchCPInstanceException noSuchCPInstanceException) {

		return new Problem(
			Response.Status.NOT_FOUND, noSuchCPInstanceException.getMessage());
	}
