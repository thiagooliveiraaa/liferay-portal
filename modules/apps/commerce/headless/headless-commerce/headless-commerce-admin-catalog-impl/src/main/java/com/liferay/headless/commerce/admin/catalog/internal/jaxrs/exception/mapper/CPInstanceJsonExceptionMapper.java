...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.CPInstanceJsonExceptionMapper"
	},
...
public class CPInstanceJsonExceptionMapper
	...
	protected Problem getProblem(
		CPInstanceJsonException cpInstanceJsonException) {

		return new Problem(
			Response.Status.BAD_REQUEST, cpInstanceJsonException.getMessage());
	}
