...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.CPDefinitionDisplayDateExceptionMapper"
	},
...
public class CPDefinitionDisplayDateExceptionMapper
	...
	protected Problem getProblem(
		CPDefinitionDisplayDateException cpDefinitionDisplayDateException) {

		return new Problem(
			Response.Status.BAD_REQUEST,
			cpDefinitionDisplayDateException.getMessage());
	}
