...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.CPDefinitionVirtualSettingTermsOfUseExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class CPDefinitionVirtualSettingTermsOfUseExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(
			...
			cpDefinitionVirtualSettingTermsOfUseException.getMessage());
	}
