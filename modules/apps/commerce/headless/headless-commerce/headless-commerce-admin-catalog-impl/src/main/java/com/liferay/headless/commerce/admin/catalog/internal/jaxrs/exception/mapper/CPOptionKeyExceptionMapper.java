...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.CPOptionKeyExceptionMapper"
	},
...
public class CPOptionKeyExceptionMapper
	...
	@Override
	protected Problem getProblem(CPOptionKeyException cpOptionKeyException) {
		return new Problem(
			Response.Status.CONFLICT, cpOptionKeyException.getMessage());
	}
