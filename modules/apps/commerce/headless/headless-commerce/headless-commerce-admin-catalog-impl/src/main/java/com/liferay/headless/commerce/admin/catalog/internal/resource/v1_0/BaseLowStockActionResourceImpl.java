...
public abstract class BaseLowStockActionResourceImpl
	implements EntityModelResource, LowStockActionResource,
			   VulcanBatchEngineTaskItemDelegate<LowStockAction> {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/low-stock-actions/export-batch'  -u 'test@liferay.com:test'
	 */
	...
	public Response postLowStockActionsPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				LowStockAction.class.getName(), callbackURL, contentType,
				fieldNames)
		).build();
	}
	...
	public void create(
			Collection<LowStockAction> lowStockActions,
	...
	@Override
	public Page<LowStockAction> read(
			Filter filter, Pagination pagination, Sort[] sorts,
			Map<String, Serializable> parameters, String search)
		throws Exception {

		return getLowStockActionsPage();
	}
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<LowStockAction>,
			 UnsafeConsumer<LowStockAction, Exception>, Exception>
