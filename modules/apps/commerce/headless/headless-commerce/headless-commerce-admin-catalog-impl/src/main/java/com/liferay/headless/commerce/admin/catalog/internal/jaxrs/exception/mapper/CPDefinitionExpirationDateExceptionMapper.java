...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.CPDefinitionExpirationDateExceptionMapper"
	},
...
public class CPDefinitionExpirationDateExceptionMapper
	...
	protected Problem getProblem(
		CPDefinitionExpirationDateException
			cpDefinitionExpirationDateException) {

		return new Problem(
			Response.Status.BAD_REQUEST,
			cpDefinitionExpirationDateException.getMessage());
	}
