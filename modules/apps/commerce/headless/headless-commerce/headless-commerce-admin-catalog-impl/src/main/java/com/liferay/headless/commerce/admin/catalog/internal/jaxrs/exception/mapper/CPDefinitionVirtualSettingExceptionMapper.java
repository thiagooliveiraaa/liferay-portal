...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.CPDefinitionVirtualSettingExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class CPDefinitionVirtualSettingExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(
			...
			cpDefinitionVirtualSettingException.getMessage());
	}
