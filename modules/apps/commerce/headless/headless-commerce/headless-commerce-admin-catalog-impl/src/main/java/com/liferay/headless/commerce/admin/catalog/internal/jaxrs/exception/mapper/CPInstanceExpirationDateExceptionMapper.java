...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.CPInstanceExpirationDateExceptionMapper"
	},
...
public class CPInstanceExpirationDateExceptionMapper
	...
	protected Problem getProblem(
		CPInstanceExpirationDateException cpInstanceExpirationDateException) {

		return new Problem(
			Response.Status.BAD_REQUEST,
			cpInstanceExpirationDateException.getMessage());
	}
