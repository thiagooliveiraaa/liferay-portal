...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.CPSpecificationOptionTitleExceptionMapper"
	},
...
public class CPSpecificationOptionTitleExceptionMapper
	...
	protected Problem getProblem(
		CPSpecificationOptionTitleException
			cpSpecificationOptionTitleException) {

		return new Problem(
			Response.Status.BAD_REQUEST,
			cpSpecificationOptionTitleException.getMessage());
	}
