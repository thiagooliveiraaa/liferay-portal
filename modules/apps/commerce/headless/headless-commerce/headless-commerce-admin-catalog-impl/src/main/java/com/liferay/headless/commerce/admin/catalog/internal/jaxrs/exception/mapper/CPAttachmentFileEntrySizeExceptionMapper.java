...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.CPAttachmentFileEntrySizeExceptionMapper"
	},
...
public class CPAttachmentFileEntrySizeExceptionMapper
	...
	protected Problem getProblem(
		CPAttachmentFileEntrySizeException cpAttachmentFileEntrySizeException) {

		return new Problem(
			Response.Status.BAD_REQUEST,
			cpAttachmentFileEntrySizeException.getMessage());
	}
