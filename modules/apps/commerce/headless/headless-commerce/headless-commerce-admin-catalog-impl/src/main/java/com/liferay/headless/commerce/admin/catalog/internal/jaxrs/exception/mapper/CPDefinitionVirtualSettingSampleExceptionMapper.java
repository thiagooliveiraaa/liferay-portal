...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.CPDefinitionVirtualSettingSampleExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class CPDefinitionVirtualSettingSampleExceptionMapper
	extends BaseExceptionMapper<CPDefinitionVirtualSettingSampleException> {
	...
	protected Problem getProblem(
		...
		return new Problem(
			...
			cpDefinitionVirtualSettingSampleException.getMessage());
	}
