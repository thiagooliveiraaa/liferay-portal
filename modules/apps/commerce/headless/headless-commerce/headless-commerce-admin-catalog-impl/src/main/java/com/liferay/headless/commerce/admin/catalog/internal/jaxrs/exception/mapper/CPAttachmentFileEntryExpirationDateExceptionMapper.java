...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.CPAttachmentFileEntryExpirationDateExceptionMapper"
	},
...
public class CPAttachmentFileEntryExpirationDateExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(
			...
			cpAttachmentFileEntryExpirationDateException.getMessage());
	}
