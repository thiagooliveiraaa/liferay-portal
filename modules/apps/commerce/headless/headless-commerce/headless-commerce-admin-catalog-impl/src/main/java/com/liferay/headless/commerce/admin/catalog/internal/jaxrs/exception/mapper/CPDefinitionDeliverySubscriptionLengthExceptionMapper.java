...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.CPDefinitionDeliverySubscriptionLengthExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class CPDefinitionDeliverySubscriptionLengthExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(
			...
			cpDefinitionDeliverySubscriptionLengthException.getMessage());
	}
