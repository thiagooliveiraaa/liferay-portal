...
public abstract class BaseLinkedProductResourceImpl
	implements EntityModelResource, LinkedProductResource,
			   VulcanBatchEngineTaskItemDelegate<LinkedProduct> {
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/channels/{channelId}/products/{productId}/linked-products"
	)
	...
	public void create(
			Collection<LinkedProduct> linkedProducts,
	...
	@Override
	public Page<LinkedProduct> read(
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<LinkedProduct>,
			 UnsafeConsumer<LinkedProduct, Exception>, Exception>
