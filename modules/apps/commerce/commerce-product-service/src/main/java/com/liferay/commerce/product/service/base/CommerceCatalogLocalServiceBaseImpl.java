...
public abstract class CommerceCatalogLocalServiceBaseImpl
	...
	implements AopService, CommerceCatalogLocalService,
	...
	public CommerceCatalog getCommerceCatalogByExternalReferenceCode(
		...
		return commerceCatalogPersistence.findByERC_C(
			externalReferenceCode, companyId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CommerceCatalogLocalServiceImpl#deleteCommerceCatalog(CommerceCatalog) to avoid orphaned data");
		}
	...
	protected void deactivate() {
		CommerceCatalogLocalServiceUtil.setService(null);
	}

	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CommerceCatalogLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		commerceCatalogLocalService = (CommerceCatalogLocalService)aopProxy;

		CommerceCatalogLocalServiceUtil.setService(commerceCatalogLocalService);
	}
