...
public abstract class CPOptionValueLocalServiceBaseImpl
	...
	implements AopService, CPOptionValueLocalService, IdentifiableOSGiService {
	...
	public CPOptionValue getCPOptionValueByExternalReferenceCode(
		...
		return cpOptionValuePersistence.findByERC_C(
			externalReferenceCode, companyId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CPOptionValueLocalServiceImpl#deleteCPOptionValue(CPOptionValue) to avoid orphaned data");
		}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CPOptionValueLocalService.class, IdentifiableOSGiService.class,
