...
public abstract class CPDefinitionLinkLocalServiceBaseImpl
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return cpDefinitionLinkPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return cpDefinitionLinkPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CPDefinitionLinkLocalServiceImpl#deleteCPDefinitionLink(CPDefinitionLink) to avoid orphaned data");
		}
	...
	public <R, E extends Throwable> R updateWithUnsafeFunction(
		...
		return updateUnsafeFunction.apply(cpDefinitionLinkPersistence);
	}
