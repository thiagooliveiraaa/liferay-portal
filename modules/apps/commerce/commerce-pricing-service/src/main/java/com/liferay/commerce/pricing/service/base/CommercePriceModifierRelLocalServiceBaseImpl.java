...
public abstract class CommercePriceModifierRelLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CommercePriceModifierRelLocalServiceImpl#deleteCommercePriceModifierRel(CommercePriceModifierRel) to avoid orphaned data");
		}
	...
	public <R, E extends Throwable> R updateWithUnsafeFunction(
		...
		return updateUnsafeFunction.apply(commercePriceModifierRelPersistence);
	}
