...
public abstract class CommerceTaxFixedRateLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CommerceTaxFixedRateLocalServiceImpl#deleteCommerceTaxFixedRate(CommerceTaxFixedRate) to avoid orphaned data");
		}
	...
	protected void deactivate() {
		CommerceTaxFixedRateLocalServiceUtil.setService(null);
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		CommerceTaxFixedRateLocalServiceUtil.setService(
			commerceTaxFixedRateLocalService);
	}
