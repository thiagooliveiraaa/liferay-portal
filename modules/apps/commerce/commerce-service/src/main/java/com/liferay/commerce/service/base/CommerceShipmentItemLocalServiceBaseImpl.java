...
public abstract class CommerceShipmentItemLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CommerceShipmentItemLocalServiceImpl#deleteCommerceShipmentItem(CommerceShipmentItem) to avoid orphaned data");
		}
	...
	protected void deactivate() {
		CommerceShipmentItemLocalServiceUtil.setService(null);
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		CommerceShipmentItemLocalServiceUtil.setService(
			commerceShipmentItemLocalService);
	}
