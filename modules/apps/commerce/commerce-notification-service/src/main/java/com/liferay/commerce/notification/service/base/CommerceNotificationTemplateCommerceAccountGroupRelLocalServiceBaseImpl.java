...
public abstract class
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CommerceNotificationTemplateCommerceAccountGroupRelLocalServiceImpl#deleteCommerceNotificationTemplateCommerceAccountGroupRel(CommerceNotificationTemplateCommerceAccountGroupRel) to avoid orphaned data");
		}
