...
public abstract class CommercePriceListAccountRelLocalServiceBaseImpl
	...
	implements AopService, CommercePriceListAccountRelLocalService,
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CommercePriceListAccountRelLocalServiceImpl#deleteCommercePriceListAccountRel(CommercePriceListAccountRel) to avoid orphaned data");
		}
	...
	@Override
	public BasePersistence<CommercePriceListAccountRel> getBasePersistence() {
	...
	protected void deactivate() {
		CommercePriceListAccountRelLocalServiceUtil.setService(null);
	}
	...
	public void setAopProxy(Object aopProxy) {
		commercePriceListAccountRelLocalService =
			(CommercePriceListAccountRelLocalService)aopProxy;

		CommercePriceListAccountRelLocalServiceUtil.setService(
			commercePriceListAccountRelLocalService);
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommercePriceListAccountRelLocalServiceBaseImpl.class);
