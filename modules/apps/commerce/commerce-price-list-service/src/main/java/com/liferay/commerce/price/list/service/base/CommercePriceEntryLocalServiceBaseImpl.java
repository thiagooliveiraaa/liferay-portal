...
public abstract class CommercePriceEntryLocalServiceBaseImpl
	...
	implements AopService, CommercePriceEntryLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CommercePriceEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CommercePriceEntryLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return commercePriceEntryPersistence.dslQuery(dslQuery);
	}
	...
	public CommercePriceEntry getCommercePriceEntryByExternalReferenceCode(
		...
		return commercePriceEntryPersistence.findByERC_C(
			externalReferenceCode, companyId);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return commercePriceEntryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CommercePriceEntryLocalServiceImpl#deleteCommercePriceEntry(CommercePriceEntry) to avoid orphaned data");
		}
	...
	protected void deactivate() {
		CommercePriceEntryLocalServiceUtil.setService(null);
	}

	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CommercePriceEntryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		commercePriceEntryLocalService =
			(CommercePriceEntryLocalService)aopProxy;

		CommercePriceEntryLocalServiceUtil.setService(
			commercePriceEntryLocalService);
	}
	...
	public <R, E extends Throwable> R updateWithUnsafeFunction(
		...
		return updateUnsafeFunction.apply(commercePriceEntryPersistence);
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommercePriceEntryLocalServiceBaseImpl.class);
