 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.commerce.price.list.service.impl.CommercePriceListOrderTypeRelLocalServiceImpl}.
 * </p>
 *
 * @author Alessio Antonio Rendina
 * @see com.liferay.commerce.price.list.service.impl.CommercePriceListOrderTypeRelLocalServiceImpl
 * @generated
 */
public abstract class CommercePriceListOrderTypeRelLocalServiceBaseImpl
	...
	public CommercePriceListOrderTypeRel createCommercePriceListOrderTypeRel(
		...
		return commercePriceListOrderTypeRelPersistence.create(
	...
	public CommercePriceListOrderTypeRel deleteCommercePriceListOrderTypeRel(
		...
		return commercePriceListOrderTypeRelPersistence.remove(
			commercePriceListOrderTypeRelId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return commercePriceListOrderTypeRelPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CommercePriceListOrderTypeRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return commercePriceListOrderTypeRelPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return commercePriceListOrderTypeRelPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public CommercePriceListOrderTypeRel fetchCommercePriceListOrderTypeRel(
		...
		return commercePriceListOrderTypeRelPersistence.fetchByPrimaryKey(
			commercePriceListOrderTypeRelId);
	}
	...
	public CommercePriceListOrderTypeRel
		...
		return commercePriceListOrderTypeRelPersistence.fetchByUuid_C_First(
			uuid, companyId, null);
	}
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, commercePriceListOrderTypeRel);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CommercePriceListOrderTypeRelLocalServiceImpl#deleteCommercePriceListOrderTypeRel(CommercePriceListOrderTypeRel) to avoid orphaned data");
		}

		return commercePriceListOrderTypeRelLocalService.
			deleteCommercePriceListOrderTypeRel(
				(CommercePriceListOrderTypeRel)persistedModel);
	}

	@Override
	public BasePersistence<CommercePriceListOrderTypeRel> getBasePersistence() {
	...
	public CommercePriceListOrderTypeRel
		...
		return commercePriceListOrderTypeRelPersistence.findByUuid_C_First(
			uuid, companyId, null);
	}
	...
	public List<CommercePriceListOrderTypeRel>
		...
		return commercePriceListOrderTypeRelPersistence.findAll(start, end);
	}
	...
	public int getCommercePriceListOrderTypeRelsCount() {
		return commercePriceListOrderTypeRelPersistence.countAll();
	}
	...
	protected void deactivate() {
		CommercePriceListOrderTypeRelLocalServiceUtil.setService(null);
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		CommercePriceListOrderTypeRelLocalServiceUtil.setService(
			commercePriceListOrderTypeRelLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CommercePriceListOrderTypeRelLocalService.class.getName();
	}
