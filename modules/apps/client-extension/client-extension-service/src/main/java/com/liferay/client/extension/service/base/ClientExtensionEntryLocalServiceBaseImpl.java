...
public abstract class ClientExtensionEntryLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ClientExtensionEntryLocalServiceImpl#deleteClientExtensionEntry(ClientExtensionEntry) to avoid orphaned data");
		}
	...
	public <R, E extends Throwable> R updateWithUnsafeFunction(
		...
		return updateUnsafeFunction.apply(clientExtensionEntryPersistence);
	}
