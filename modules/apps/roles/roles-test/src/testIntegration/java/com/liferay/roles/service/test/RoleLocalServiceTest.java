...
public class RoleLocalServiceTest {
	...
	public void testGetGroupRolesAndTeamRolesWithKeyword() throws Exception {
		...
		Assert.assertEquals(
			1,
			_roleLocalService.getGroupRolesAndTeamRolesCount(
				companyId, keywordRole, excludedRoleNames, keywordRole, null,
				roleTypes, 0, groupId));
		...
		Assert.assertEquals(
			1,
			_roleLocalService.getGroupRolesAndTeamRolesCount(
				companyId, keywordRole, excludedRoleNames, keywordRole,
				keywordRole, roleTypes, 0, groupId));

		roles = _roleLocalService.getGroupRolesAndTeamRoles(
			companyId, keywordRole, excludedRoleNames, keywordRole, keywordRole,
			roleTypes, 0, groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS);
		...
		Assert.assertEquals(
			1,
			_roleLocalService.getGroupRolesAndTeamRolesCount(
				companyId, keywordTeam, excludedRoleNames, keywordTeam, null,
				roleTypes, 0, groupId));
		...
		Assert.assertEquals(
			2,
			_roleLocalService.getGroupRolesAndTeamRolesCount(
				companyId, keywordTeam, excludedRoleNames, keywordTeam,
				keywordTeam, roleTypes, 0, groupId));

		roles = _roleLocalService.getGroupRolesAndTeamRoles(
			companyId, keywordTeam, excludedRoleNames, keywordTeam, keywordTeam,
			roleTypes, 0, groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS);
