...
public class LayoutSEOSitePersistenceImpl
	...
	@Override
	public Map<Serializable, LayoutSEOSite> fetchByPrimaryKeys(
		...
		Map<Serializable, LayoutSEOSite> map =
			new HashMap<Serializable, LayoutSEOSite>();
