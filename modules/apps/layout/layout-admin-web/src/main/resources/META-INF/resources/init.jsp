...
page import="com.liferay.client.extension.type.item.selector.CETItemSelectorReturnType" %><%@
...
page import="com.liferay.layout.admin.web.internal.frontend.taglib.clay.servlet.taglib.CollectionsVerticalCard" %><%@
...
page import="com.liferay.layout.admin.web.internal.frontend.taglib.clay.servlet.taglib.SelectThemeVerticalCard" %><%@
