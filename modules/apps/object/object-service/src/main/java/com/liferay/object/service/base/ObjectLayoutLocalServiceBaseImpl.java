...
public abstract class ObjectLayoutLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ObjectLayoutLocalServiceImpl#deleteObjectLayout(ObjectLayout) to avoid orphaned data");
		}
	...
	protected void deactivate() {
		ObjectLayoutLocalServiceUtil.setService(null);
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		ObjectLayoutLocalServiceUtil.setService(objectLayoutLocalService);
	}
