...
import { TObjectView, TObjectViewSortColumn, TState, TWorkflowStatus } from './types';
...
export declare function ViewContextProvider({ children, value, }: IViewContextProviderProps): JSX.Element;
