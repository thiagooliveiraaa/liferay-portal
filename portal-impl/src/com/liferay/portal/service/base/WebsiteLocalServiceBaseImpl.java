...
public abstract class WebsiteLocalServiceBaseImpl
	...
	implements IdentifiableOSGiService, WebsiteLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WebsiteLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>WebsiteLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Website.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return websitePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return websitePersistence.countWithDynamicQuery(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement WebsiteLocalServiceImpl#deleteWebsite(Website) to avoid orphaned data");
		}
